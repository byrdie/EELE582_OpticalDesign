...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	TheSystem->LoadFile(_bstr_t::_bstr_t("E:\\Users\\byrdie\\School\\Classes\\EELE582_OpticalDesign\\FinalProject\\zemax\\final1.zmx"),false);


	I_AnalysesPtr analyses = TheSystem->Analyses;

	IA_Ptr psf = analyses->Get_AnalysisAtIndex(1);
